...
@section('content')
    <div class="h-screen">
        ...
        {{-- <div class="bg-yellow-400 h-screen w-full">Di sini nanti buat map</div> --}}

        {{-- Bagian floating absen --}}
        <div class="p-4 pt-2 m-4 rounded-xl absolute bottom-0 bg-white shadow-lg right-0 left-0">
            ...
            <div id="location-allowed">
                ...
                <div class="flex">
                    ...
                    <button class="flex-col w-1/3" type="button" data-modal-toggle="modal-id">
                        <div class="rounded-md border content-center h-full mx-auto">
                            ...
                            <img src="" alt="" class="hidden " id="image">
                        </div>
                    </button>
                </div>
        ...
        <div id="modal-id"
            ...
            <div class="modal-content bg-white rounded-xl shadow p-4">
